...
export class CurriculumFlavia {
  ...
  static get() {
    ...
    projetos. Estou me especializando em métodos ágeis e me pós-graduando em gestão de projetos. Bem organizada, proativa e
    ...
    contacts.push(new KeyValue("Endereço", "QNL 12, bloco B, apartamento 113. Taguatinga Norte, cep: 72156-212."));
    ...
    educations.push({
      name: "Pós Graduação em Gestão de Projetos",
