...
export class CurriculumRafael {
  ...
  static get() {
    ...
    personal.profile = `Desenvolvedor de software competente e comprometido em entregar soluções de alta qualidade, escaláveis e eficientes, 
    sempre com o objetivo de superar as expectativas do cliente final. Dedicado a entender profundamente os requisitos do cliente, 
    garantindo qualidade de código e qualidade de entrega. Estou sempre pronto para enfrentar novos desafios e contribuir para o sucesso dos projetos, 
     aplicando minhas habilidades e experiência.`;
    ...
    knowledges.push(new KeyValue("Arquiteturas", ["Microsserviços", 
    " Em Camadas", " Orientada a serviços."]));
    ...
    knowledges.push(new KeyValue("Frameworks", [
      ...
      "Material Design", "Play Framework", "PrimeNG", "React", "React Native", 
    ...
    educations.push({
      name: "Pós Graduação - Banco de Dados com Big Data",
      institution: "Universidade Federal de Goiás - UFG",
      address: "Goiás, Goiânia",
      startDate: new Date("01/03/2022"),
      endDate: null,
    ...
    experiences.push({
      ...
      endDate: null,
      description: ` Desenvolvimento FullStack utilizando linguages de programação JAVA e Typescript com Angular Framework. Análise de problemas complexos e implementação de soluções para aprimorar
    ...
    experiences.push({
      ...
      description: ` Desenvolvimento de sistemas voltados a criação de
            ChatBots utilizando linguagem de programação Java.
